...
- Refine commit categorization and handling in `cliff.toml` config
- Remove automatic release workflow, add release to check workflow
- Update cache directory command in GitHub Action
